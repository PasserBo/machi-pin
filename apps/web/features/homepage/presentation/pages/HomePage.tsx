        ...
        >
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/login"
                className="px-8 py-4 bg-black text-white rounded-full text-lg font-semibold hover:bg-gray-800 transition transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
              >
                Get Started Free
              </Link>
              <a
                href="#how-it-works"
                className="px-8 py-4 border-2 border-gray-300 rounded-full text-lg font-semibold text-gray-900 hover:border-gray-400 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
              >
                Watch Demo
              </a>
            </div>
          ...
          <div className="mt-32 grid md:grid-cols-3 gap-8">
            <div className="bg-white/80 backdrop-blur p-8 rounded-3xl shadow-lg hover:shadow-xl transition">
              ...
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Capture Moments</h3>
            ...
            <div className="bg-white/80 backdrop-blur p-8 rounded-3xl shadow-lg hover:shadow-xl transition">
              ...
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Sketch & Doodle</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white/80 backdrop-blur p-8 rounded-3xl shadow-lg hover:shadow-xl transition">
              <div className="text-4xl mb-4">🗺️</div>
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Beautiful Maps</h3>
              <p className="text-gray-600">
          ...
          <div id="how-it-works" className="mt-32 text-center">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <h4 className="font-semibold mb-2 text-gray-900">Create a Map</h4>
              ...
              <div>
                ...
                <h4 className="font-semibold mb-2 text-gray-900">Take Photos</h4>
              ...
              <div>
                ...
                <h4 className="font-semibold mb-2 text-gray-900">Add Sketches</h4>
              ...
              <div>
                ...
                <h4 className="font-semibold mb-2 text-gray-900">Share & Cherish</h4>
          ...
          <div className="mt-32 bg-black text-white rounded-3xl p-12 text-center">
            ...
            <Link
              href="/login"
              className="inline-block px-8 py-4 bg-white text-black rounded-full text-lg font-semibold hover:bg-gray-100 transition transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
