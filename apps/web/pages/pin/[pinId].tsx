...
export default function PinPage({ pinId }: PinPageProps) {
...
// SSR for better sharing/SEO
export const getServerSideProps: GetServerSideProps<PinPageProps> = async (context) => {
  const { pinId } = context.params as { pinId: string };

  // TODO: Fetch pin data from Firebase
  // For now, just pass the pinId
